        ...
        <div class="user-menu-container relative">
          ...
          >
              ...
              <div v-if="versionInfo.hasUpdate" class="mt-2">
                <div class="mb-2 flex items-center justify-between text-sm">
                  <span class="font-medium text-green-600 dark:text-green-400">
                    <i class="fas fa-arrow-up mr-1" />{{ $t('header.hasNewVersion') }}
                  </span>
                ...
                <transition mode="out-in" name="fade">
                  ...
                  >
                    <p class="text-xs font-medium text-green-700 dark:text-green-400">
                      <i class="fas fa-check-circle mr-1" />{{ $t('header.latestVersion') }}
                    </p>
                  </div>
                  <button
                    v-else
            ...
            >
              ...
              <span>{{ t('auth.editAccountInfo') }}</span>
            </button>
    ...
    <div class="modal-content mx-auto flex max-h-[90vh] w-full max-w-md flex-col p-4 sm:p-6 md:p-8">
      ...
      >
        ...
        <div>
          ...
          />
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('auth.leaveBlankToKeepUsername') }}
          </p>
        </div>
        ...
        <div class="flex gap-3 pt-4">
          ...
          >
            ...
            {{ changePasswordLoading ? t('common.loading') : t('auth.saveChanges') }}
          </button>
        </div>
      </form>
    </div>
...
const logout = () => {
  if (confirm(t('auth.confirmLogout'))) {
    authStore.logout()
    router.push('/login')
    showToast(t('auth.loggedOutSafely'), 'success')
  }
  userMenuOpen.value = false
}
